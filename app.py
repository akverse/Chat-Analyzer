    ...
    if st.sidebar.button("Show Analysis"):
        ...
        if selected_user == 'Overall':
            ...
            with col1:
                ...
                colors = viridis(np.linspace(0, 1, len(x.index)))  # Create a colormap
        ...
        fig, axs = plt.subplots(figsize=(12, 6))  # Create the figure and axes with the desired size

        # Plot the sentiment data
        axs.plot(sentiment_daily.index, sentiment_daily['positive'], label='Positive', color='green')
        axs.plot(sentiment_daily.index, sentiment_daily['negative'], label='Negative', color='red')
        axs.plot(sentiment_daily.index, sentiment_daily['neutral'], label='Neutral', color='blue')
